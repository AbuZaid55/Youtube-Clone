...
export const getRecommendedVideos = createAsyncThunk(
    ...
    async({isNext,videoId},{getState}) => {
        const {
            youtubeApp : {nextPageToken : nextPageTokenFromState,recommendedVideo,currentPlaying:{
        ...
        return {parsedData:[...recommendedVideo,...videos],nextPageToken: response.data.nextPageToken};
    }
)